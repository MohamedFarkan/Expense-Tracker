...
export const wallet = <i class="fa-solid fa-wallet"></i>;
export const rupees = (
  <i style={{ fontSize: "2rem" }} class="fa-solid fa-indian-rupee-sign"></i>
);
export const rupees2 = (
  <i style={{ fontSize: "1.3rem" }} class="fa-solid fa-indian-rupee-sign"></i>
);
export const rupees3 = (
  <i style={{ fontSize: "3rem" }} class="fa-solid fa-indian-rupee-sign"></i>
);
export const rupees4 = (
  <i style={{ fontSize: "3.8rem" }} class="fa-solid fa-indian-rupee-sign"></i>
);
